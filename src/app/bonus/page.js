...
export default function Bonus() {
    return (
        <>
            <Image src='https://firebasestorage.googleapis.com/v0/b/storage1-15612.appspot.com/o/ICTBuilding.png?alt=media&token=a2e64f54-b92f-4c18-b45a-e743b1fa28f2'
            width={1000}
            height={1000}
            alt='the front of MUICT building'></Image>
            {users.map(prop => (
                <>
                    <h1>{prop.type}</h1>
                    <h1>{prop.question}</h1>
